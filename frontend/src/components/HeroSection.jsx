...
export default function HeroSection({ onOpenGacha, onOpenFridge, onExploreMeals }) {
  return (
    <section className="relative overflow-hidden pt-6 pb-12 sm:pt-10 sm:pb-16 bg-gradient-to-b from-brand-50/60 via-white to-[#faf9f6]">
      {/* Decorative Warm Background Blobs */}
      <div className="absolute top-10 right-1/4 w-72 h-72 bg-brand-200/40 rounded-full blur-3xl -z-10 pointer-events-none"></div>
      <div className="absolute bottom-0 left-10 w-80 h-80 bg-amber-100/60 rounded-full blur-3xl -z-10 pointer-events-none"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          
          {/* Left Column: Text & CTAs (Inspired by Cook. mockup) */}
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <p className="text-base sm:text-lg text-stone-600 max-w-2xl mx-auto lg:mx-0 font-normal leading-relaxed">
              ...
              Bạn có thể xem công thức để <em>tự nấu</em> từ nguyên liệu sẵn có, hoặc mở bản đồ để <em>tìm quán ngon gần nhất</em>!
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
              <button
                onClick={onOpenGacha}
                className="w-full sm:w-auto px-7 py-3.5 rounded-2xl bg-gradient-to-r from-brand-600 to-brand-500 hover:from-brand-700 hover:to-brand-600 text-white font-bold text-sm sm:text-base shadow-warm-md hover:shadow-warm-lg hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2.5 group"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-3.5 rounded-2xl bg-white hover:bg-stone-50 text-stone-800 border border-stone-200 hover:border-emerald-300 font-bold text-sm sm:text-base shadow-sm hover:shadow-md transition-all flex items-center justify-center gap-2.5"
              >
            ...
            {/* Quick Metrics */}
            <div className="pt-4 grid grid-cols-3 gap-4 border-t border-stone-200/80 max-w-md mx-auto lg:mx-0 text-center lg:text-left">
              <div>
          ...
          {/* Right Column: Hero Visual Illustration / Interactive Feature Card */}
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              
              {/* Main Visual Image Card */}
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white aspect-[4/3] sm:aspect-square bg-stone-100 group">
                <img
              ...
              <div className="absolute -top-4 -left-4 sm:-left-6 bg-white/95 backdrop-blur-md rounded-2xl p-3.5 shadow-warm-lg border border-stone-100 flex items-center gap-3 animate-float">
              ...
              <div className="absolute -bottom-4 -right-2 sm:-right-4 bg-white/95 backdrop-blur-md rounded-2xl p-3 shadow-warm-lg border border-stone-100 flex items-center gap-2.5">
